        ...
        <>
            <div className="bg-white p-4 mt-1">
                {isGuestMode ? (
                    ...
                    isCoworking ? (
                        <>
                            <h3 className="text-lg font-semibold text-purple-600 mb-3">Observaciones (opcional)</h3>
                            <textarea
                                value={description}
                        ...
                        <>
                            <h3 className="text-lg font-semibold text-purple-600 mb-1">Título de la reserva</h3>
                            <input
                                type="text"
                                value={title}
                                onChange={(e) => setTitle(e.target.value)}
                                placeholder="Ingrese el título de la reserva"
                                className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 mb-4"
                            />

                            <h3 className="text-lg font-semibold text-purple-600 mb-3">Descripción de la reserva</h3>
                            <textarea
                                value={description}
                                onChange={(e) => setDescription(e.target.value)}
