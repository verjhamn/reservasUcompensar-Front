...
const CampusSelector = ({ selectedCampus, onSelectCampus }) => {
    ...
    const activeCampuses = campuses.filter(c => isSedeActive(c.value));
                    ...
                    >
                        ...
                        <div className="h-48 relative overflow-hidden group-hover:scale-105 transition-transform duration-700">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center z-10">
                                <div className="bg-white/20 backdrop-blur-sm rounded-full p-6 transition-transform group-hover:scale-110">
